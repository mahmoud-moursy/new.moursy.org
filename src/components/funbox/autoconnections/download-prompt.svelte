  ...
  {:then wordBin}
    {#if wordBin === undefined}
      ...
      <section class="p-4 flex flex-col gap-4 bg-red-600/10">
        ...
        <p>
          While reasonable efforts have been made to ensure a clean experience, some autogenerated
          connections may <b>contain profanity</b>, <b>have inappropriate connotations</b>, or other
          be <b>kid unfriendly</b>. While the chances of this occurring are rare in my testing,
